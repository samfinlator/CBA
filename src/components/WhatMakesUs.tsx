    ...
    >
      ...
      >
        <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 40 }}>
          <img src="/assets/left-connector-down.svg" alt="" className="absolute" style={{ top: 0, left: active ? 0 : railLeft, width: 11, height: 12, zIndex: 2 }} />
          <img src="/assets/right-connector-down.svg" alt="" className="absolute" style={{ top: 0, right: 0, width: 12, height: 12, zIndex: 2 }} />
          <img src="/assets/left-connector-up.svg" alt="" className="absolute" style={{ bottom: 0, left: active ? 0 : railLeft, width: 11, height: 12, zIndex: 2 }} />
          <img src="/assets/right-connector-up.svg" alt="" className="absolute" style={{ bottom: 0, right: 0, width: 11, height: 12, zIndex: 2 }} />
          <div className="absolute" style={{ top: 0, left: active ? 21 : railLeft + 11, right: 21, height: 1.5, backgroundColor: "#E9E9E9" }} />
          <div className="absolute" style={{ bottom: 0, left: active ? 21 : railLeft + 11, right: 21, height: 1.5, backgroundColor: "#E9E9E9" }} />
          {active && (
            <div className="absolute" style={{ left: 0, top: 22, bottom: 22, width: 1.5, backgroundColor: "#E9E9E9" }} />
          )}
          <div className="absolute" style={{ right: 0, top: active ? 22 : 0, bottom: active ? 22 : 0, width: 1.5, backgroundColor: "#E9E9E9" }} />
        </div>
        ...
        <div className="relative" style={{ backgroundColor: "var(--color-page)" }}>
          <div
            ...
            style={{
              ...
              gap: isDesktop ? desktopRowGap : 28,
              paddingTop: 24,
              paddingBottom: 24,
            }}
          >
            ...
            <div
              style={{
                minWidth: 0,
                flex: isCompact ? "0 0 auto" : `0 0 ${cardsW}px`,
                display: "flex",
                flexDirection: "row",
                flexWrap: "nowrap",
                gap,
                ...
                width: isCompact ? "calc(100% + 40px)" : cardsW,
              }}
